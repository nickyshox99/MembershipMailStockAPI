...
INSERT INTO `admins` (`id`, `adminName`, `hash`, `salt`, `fullName`, `status`, `createdAt`, `createdBy`, `updatedAt`, `updatedBy`, `am_rank`, `am_group`) VALUES
(49, 'admin', '$2b$10$P/84ulOyGQfxcVhG49p6P.N07tb4l9tVGdhNfw/sLqwphUOa1XUqi', '$2b$10$P/84ulOyGQfxcVhG49p6P.', 'admin', 1, '2025-07-06 19:18:47', 'superwin2', '2025-07-06 19:18:47', 'superwin2', 4, 1);
...
INSERT INTO `admin_truewallet` (`id`, `meta_data`, `login_status`, `status`) VALUES
(4, '{\"tw_type\":\"DEPOSIT\",\"tw_type_wallet\":\"DEPOSIT_GIFT\",\"tw_mobile\":\"0825134967\",\"tw_name\":\"0825134967\",\"tw_username\":\"\",\"tw_password\":\"\",\"tw_pin\":\"\",\"tw_key\":\" \"}', 0, 0);
...
CREATE TABLE `am_group` (
  ...
  `status` int NOT NULL,
  `default_page` varchar(200) NOT NULL DEFAULT '',
  `default_page_th` varchar(255) NOT NULL DEFAULT '',
  `default_page_id` int NOT NULL DEFAULT '0'
...
INSERT INTO `am_group` (`id`, `name`, `permission`, `status`, `default_page`, `default_page_th`, `default_page_id`) VALUES
(1, 'Admin', '6,5,13,17,33,35,10,9,3,16,4,15,14,8,53,56,50,49,52,2,48,47,58,57,76,55,59,60,75,72,51,62,61,66,63,79,69,81,82,80,68,83,84,85,1,86,87,88,89,90,91,92,93,94,95,96', 1, 'apps-members-manage', 'จัดการสมาชิก', 2),
(3, 'Super Admin', '30,29,7,34,38,22,40,39,42,44,25,24,18,26,20,21,19,31,36,43,37,23,32,6,8,14,5,27,17,12,16,4,15,41,1,3,28,11,2,9,10,35,33,13,55,59,60,75,69,72,63,61,64,68,70,71,67,74,45,73,46,76,52,51,49,54,47,48,50,58,57,62,56,53,77,66,65,79,83,84,85,1,86,80,81,82,89,90,91,92,93,94,95,96', 1, 'apps-members-manage', 'จัดการสมาชิก', 2);

-- --------------------------------------------------------

--
-- Table structure for table `am_group_page_permission`
--

CREATE TABLE `am_group_page_permission` (
  `id` int NOT NULL,
  `am_group_id` int NOT NULL,
  `page_admin_id` int NOT NULL,
  `can_view1` tinyint(1) NOT NULL DEFAULT '1',
  `can_edit1` tinyint(1) NOT NULL DEFAULT '1',
  `can_delete1` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `am_group_page_permission` (`id`, `am_group_id`, `page_admin_id`, `can_view1`, `can_edit1`, `can_delete1`, `can_add1`, `can_approve1`, `can_viewall1`) VALUES
(4, 1, 79, 1, 1, 1, 1, 0, 0),
(6, 1, 84, 1, 0, 0, 0, 0, 0),
(7, 1, 85, 1, 0, 0, 0, 0, 0),
(8, 4, 84, 1, 0, 0, 0, 0, 0),
...
(13, 6, 83, 1, 0, 0, 0, 0, 0),
(15, 11, 2, 1, 1, 1, 1, 0, 1),
(16, 11, 80, 1, 1, 1, 1, 0, 1),
(17, 11, 81, 1, 1, 1, 1, 0, 1),
(18, 11, 82, 1, 1, 1, 1, 0, 1),
(19, 11, 83, 1, 1, 1, 1, 0, 1),
(20, 11, 84, 1, 1, 1, 1, 0, 1),
(21, 11, 79, 1, 1, 1, 1, 0, 1);
...
(1, 'กสิกรไทย', 'kbank.jpg', '#018941', 1, '004', '004', '4', 'KBANK'),
(2, 'กรุงเทพ', 'bbl.jpg', '#1e4598', 2, '002', '002', '2', 'BBL'),
(3, 'กรุงไทย', 'ktb.jpg', '#1ba5e1', 4, '006', '006', '0', 'KTB'),
(4, 'กรุงศรีอยุธยา', 'bay.jpg', '#fec43b', 19, '025', '0', '25', 'BAY'),
(5, 'ไทยพาณิชย์', 'scb.jpg', '#4e2e7f', 10, '0', '014', '14', 'SCB'),
(6, 'เกียรตินาคิน', 'kk.jpg', '#199cc5', 120, '069', '069', '69', ''),
(7, 'เจพีมอร์แกน เชส สาขากรุงเทพฯ', 'jpm.jpg', '#321c10', 6, '', '', '8', ''),
(8, 'ซิตี้แบ้งค์', 'citi.jpg', '#1583c7', 12, '017', '017', '17', ''),
(9, 'ซีไอเอ็มบี ไทย', 'cimb.jpg', '#7e2f36', 17, '022', '022', '22', 'CIMBT'),
(10, 'ซูมิโตโม มิตซุย แบงกิ้ง', 'smbc.jpg', '#a0d235', 123, '018', '018', '18', ''),
(11, 'ดอยซ์แบงก็', 'db.jpg', '#0522a5', 26, '032', '032', '32', ''),
(12, 'ทหารไทย', 'ttb.jpg', '#1279be', 8, '011', '011', '11', 'TMB'),
(13, 'ทิสโก้', 'tisco.jpg', '#12549f', 100, '067', '067', '67', ''),
(14, 'ธนชาต', 'tbank.png', '#fc4f1f', 106, '065', '065', '65', 'TBANK'),
(15, 'บีเอ็นพี พารีบาส์ สาขากรุงเทพฯ', 'bnp.jpg', '#14925e', 117, '', '', '45', ''),
(16, 'เพื่อการเกษตรและสหกรณ์การเกษตร', 'baac.jpg', '#4b9b1d', 119, '034', '034', '34', 'BAAC'),
(17, 'มิซูโฮ คอร์ปอเรต สาขากรุงเทพฯ', 'mb.jpg', '#150b78', 28, '039', '039', '39', ''),
(18, 'เมกะ สากลพาณิชย์', 'mega.jpg', '#815e3b', 20, '', '', '26', ''),
(19, 'ยูโอบี', 'uob.jpg', '#0b3979', 18, '024', '024', '24', 'UOBT'),
(20, 'แลนด์ แอนด์ เฮ้าส', 'lhb.jpg', '#6d6e71', 111, '073', '073', '73', ''),
(21, 'สแตนดาร์ดชาร์เตอร์ด (ไทย)', 'sc.jpg', '#0f6ea1', 122, '020', '020', '20', ''),
(22, 'แห่งประเทศจีน (ไทย)', 'icbc.jpg', '#c50f1c', 121, '070', '070', '52', ''),
(23, 'แห่งอเมริกาฯ', 'boa.jpg', '#e11e3c', 21, '', '', '27', ''),
(24, 'ออมสิน', 'gsb.jpg', '#eb198d', 24, '030', '030', '30', 'GSB'),
(25, 'อาคารสงเคราะห์', 'ghb.jpg', '#f57d23', 27, '033', '033', '33', ''),
(26, 'อิสลามแห่งประเทศไทย', 'ibank.jpg', '#184615', 118, '066', '066', '66', ''),
(27, 'ไอซีบีซี (ไทย)', 'icbc.jpg', '#c50f1c', 105, '070', '070', '70', ''),
(28, 'ฮ่องกงและเซี่ยงไฮ้', 'hsbc.png', '#fd0d1b', 25, '031', '031', '31', ''),
(29, 'Truewallet', 'tw.png', '#ff8300', 29, '29', '29', '29', 'TW');

-- --------------------------------------------------------

--
-- Table structure for table `bank_running`
--

CREATE TABLE `bank_running` (
  `id` int NOT NULL,
  `Bank` varchar(10) NOT NULL DEFAULT '',
  `RunningDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `IsRunning` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

--
-- Dumping data for table `bank_running`
--

INSERT INTO `bank_running` (`id`, `Bank`, `RunningDate`, `IsRunning`) VALUES
(1, 'SCB', '2023-10-23 02:09:00', 0),
(2, 'KBANK', '2023-10-23 02:09:00', 0);
...
--
-- Table structure for table `email_accept_member`
--
...
--
-- Table structure for table `groupid_running`
--

CREATE TABLE `groupid_running` (
  `id` int NOT NULL,
  `running` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `groupid_running`
--

INSERT INTO `groupid_running` (`id`, `running`) VALUES
(1, 1);
...
INSERT INTO `key_check` (`id`, `key_`) VALUES
(1, 'f30c10495f1ffbcf51127b968fbf3742');

-- --------------------------------------------------------

--
-- Table structure for table `latest_line_update`
--

CREATE TABLE `latest_line_update` (
  `id` int NOT NULL,
  `datetime_update` datetime NOT NULL,
  `hd_status` int NOT NULL DEFAULT '0',
  `version` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

--
-- Dumping data for table `latest_line_update`
--

INSERT INTO `latest_line_update` (`id`, `datetime_update`, `hd_status`, `version`) VALUES
(6, '2024-02-22 00:00:00', 1, 2024022023),
(7, '2024-02-23 00:00:00', 1, 2024022300),
(8, '2024-02-24 00:00:00', 1, 2024022301),
(9, '2024-02-25 00:00:00', 1, 2024022321),
(10, '2024-02-26 00:00:00', 1, 2024022418),
(11, '2024-02-27 00:00:00', 1, 2024022518),
(12, '2024-02-28 00:00:00', 1, 2024060518),
(13, '2024-02-29 00:00:00', 1, 2024060519),
(14, '2024-03-01 00:00:00', 1, 2024060519),
(15, '2024-03-02 00:00:00', 1, 2024070815),
(16, '2024-03-03 00:00:00', 1, 2024070820),
(17, '2024-03-04 00:00:00', 1, 2024071003),
(18, '2024-03-05 00:00:00', 1, 2025041503),
(19, '2024-03-06 00:00:00', 1, 2025042115),
(20, '2024-03-07 00:00:00', 1, 2025042116),
(21, '2024-03-08 00:00:00', 1, 2025042117),
(22, '2024-03-09 00:00:00', 1, 2025042118);
...
--
-- Dumping data for table `line_chat_active`
--

INSERT INTO `line_chat_active` (`id`, `bot_user_id`, `chat_with_user_id`, `chat_datetime`, `last_chattime`, `active`, `reply_by`, `reply_datetime`, `close_by`, `reply_token`) VALUES
(1, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', '2025-07-08 06:00:30', '2025-07-08 06:04:55', 0, NULL, '2025-07-07 23:00:31', 'SYSTEM', '1efa9320d5414699b7b00cbfe3e3136e'),
(2, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', '2025-07-08 10:30:21', '2025-07-08 10:39:32', 1, NULL, '2025-07-08 03:30:21', NULL, '20f459d6ae6441c0b24848b6bf53b3a1'),
...
--
-- Table structure for table `line_chat_message`
--
...
--
-- Dumping data for table `line_chat_message`
--

INSERT INTO `line_chat_message` (`id`, `bot_user_id`, `chat_with_user_id`, `line_chat_active_id`, `message_datetime`, `message`, `message_type`, `reply_to_id`, `message_detail`, `is_read`, `is_deleted`, `is_sending`, `send_by`, `send_completed`) VALUES
(1, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 1, '2025-07-08 06:03:09', 'โหลๆ', 0, '', '{}', 0, 0, 0, NULL, 1),
(2, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 1, '2025-07-08 06:03:12', 'ต่ออายุ', 0, '', '{}', 0, 0, 0, NULL, 1),
(3, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 1, '2025-07-08 06:03:17', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
(4, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 1, '2025-07-08 06:03:21', 'เช็ควัน', 0, '', '{}', 0, 0, 0, NULL, 1),
(5, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 1, '2025-07-08 06:04:49', 'เช็ควัน', 0, '', '{}', 0, 0, 0, NULL, 1),
(6, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 1, '2025-07-08 06:04:55', 'สมัคร', 0, '', '{}', 0, 0, 0, NULL, 1),
(7, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 2, '2025-07-08 10:30:21', 'สมัคร', 0, '', '{}', 0, 0, 0, NULL, 1),
(8, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 2, '2025-07-08 10:35:31', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
(9, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U50de7455d93dbd50e652094e0e878e3a', 2, '2025-07-08 10:39:32', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
(10, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:05:19', '', 1, '', '{\"type\":\"sticker\",\"id\":\"569111712012960326\",\"quoteToken\":\"Nt17Qgd566CG6Y-fe9wjQ3hND6Flp8imwYJbdlNFAv7U_DN_ELuuNeBLmUl8qb0eJ9CSKMiAmZRKWif5YlsfC01OAe_D8LUnpqqhYpbJVadIMPamwTcUihHDvF8bVUcIsq4z0GTiHeSf0IPfW14vxg\",\"stickerId\":\"540504446\",\"packageId\":\"21152400\",\"stickerResourceType\":\"STATIC\"}', 0, 0, 0, NULL, 1),
(11, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:07:54', 'สนใจ', 0, '', '{}', 0, 0, 0, NULL, 1),
(12, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:08:10', 'สมัคร', 0, '', '{}', 0, 0, 0, NULL, 1),
(13, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:12:47', 'สมัครสมาชิก', 0, '', '{}', 0, 0, 0, NULL, 1),
(14, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:13:56', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
(15, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:14:00', 'เช็ควัน', 0, '', '{}', 0, 0, 0, NULL, 1),
(16, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:14:09', 'ต่ออายุ', 0, '', '{}', 0, 0, 0, NULL, 1),
(17, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:14:15', 'สมัคร', 0, '', '{}', 0, 0, 0, NULL, 1),
(18, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:14:19', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
(19, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:14:36', 'Kannat2547@gmail.com', 0, '', '{}', 0, 0, 0, NULL, 1),
(20, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 3, '2025-07-09 15:14:43', 'สมัคร', 0, '', '{}', 0, 0, 0, NULL, 1),
(21, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 4, '2025-07-21 11:17:42', 'สมัครสมาชิก', 0, '', '{}', 0, 0, 0, NULL, 1),
(22, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 4, '2025-07-21 11:18:26', 'เช็ควัน', 0, '', '{}', 0, 0, 0, NULL, 1),
(23, 'Uecf45f5c994d98306f3fee67921ac3d6', 'U45b7554f02a061a7620c9c9fa36411d2', 4, '2025-07-21 11:18:28', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
(24, 'Uecf45f5c994d98306f3fee67921ac3d6', 'Ue138884a48abe606128a06f2baebf36e', 5, '2025-07-29 19:41:23', 'อาโยโหย', 0, '', '{}', 0, 0, 0, NULL, 1),
(25, 'Uecf45f5c994d98306f3fee67921ac3d6', 'Ue138884a48abe606128a06f2baebf36e', 5, '2025-07-29 19:41:28', 'ฮัลโหลๆ', 0, '', '{}', 0, 0, 0, NULL, 1),
(26, 'Uecf45f5c994d98306f3fee67921ac3d6', 'Ue138884a48abe606128a06f2baebf36e', 5, '2025-07-29 19:41:33', 'สมัครสมาชิก', 0, '', '{}', 0, 0, 0, NULL, 1),
(27, 'Uecf45f5c994d98306f3fee67921ac3d6', 'Ue138884a48abe606128a06f2baebf36e', 5, '2025-07-29 19:42:55', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
(28, 'Uecf45f5c994d98306f3fee67921ac3d6', 'Ue138884a48abe606128a06f2baebf36e', 5, '2025-07-29 19:43:06', 'เช็ควัน', 0, '', '{}', 0, 0, 0, NULL, 1),
(29, 'Uecf45f5c994d98306f3fee67921ac3d6', 'Ue138884a48abe606128a06f2baebf36e', 5, '2025-07-29 19:44:09', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
(30, 'Uecf45f5c994d98306f3fee67921ac3d6', 'Ue138884a48abe606128a06f2baebf36e', 5, '2025-07-29 19:44:22', 'ซื้อ', 0, '', '{}', 0, 0, 0, NULL, 1),
...
--
-- Table structure for table `line_contact`
--
...
--
-- Dumping data for table `line_contact`
--
...
--
-- Table structure for table `line_quick_message`
--

CREATE TABLE `line_quick_message` (
  `id` int NOT NULL,
  `line_setting_id` int DEFAULT NULL,
  `name_message` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping data for table `line_quick_message`
--

INSERT INTO `line_quick_message` (`id`, `line_setting_id`, `name_message`, `message`, `active`, `orders`) VALUES
(18, 1, 'โปรโมชั่น', '😉 โปรโมชั่น', 1, 10),
(19, 1, 'ทักทาย', 'สวัสดีค่ะ', 1, 20);

-- --------------------------------------------------------

--
-- Table structure for table `line_sent_message`
--
...
--
-- Dumping data for table `line_setting`
--
...
--
-- Table structure for table `line_sticker`
--
...
--
-- Dumping data for table `line_sticker`
--

INSERT INTO `line_sticker` (`id`, `packageId`, `stickerId`, `stickerResourceType`, `keywords`, `active`) VALUES
(1, '11537', '52002741', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(2, '11537', '52002742', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(3, '11537', '52002743', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(4, '11537', '52002744', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(5, '11537', '52002745', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(6, '11537', '52002746', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(7, '11537', '52002747', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(8, '11537', '52002748', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(9, '11537', '52002749', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(10, '11537', '52002750', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(11, '11537', '52002751', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(12, '11537', '52002752', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(13, '11537', '52002753', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(14, '11537', '52002754', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(15, '11537', '52002755', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(16, '11537', '52002756', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(17, '11537', '52002757', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(18, '11537', '52002758', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(19, '11537', '52002759', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1),
(20, '11537', '52002760', 'ANIMATION', '[\"jump\",\"sally\",\"hey\",\"line\",\"Hooray\",\"Happy\",\"Excited\",\"oh boy\"]', 1);

-- --------------------------------------------------------

--
-- Table structure for table `line_tag`
--
...
CREATE TABLE `membership_order_history` (
  ...
  `slip_file_url` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
  ...
  `sent_message` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `membership_order_history`
--
...
--
-- Dumping data for table `meta_promotion_popup`
--

INSERT INTO `meta_promotion_popup` (`id`, `promotion_img`, `promotion_page`, `promotion_text`, `status`) VALUES
(2, 'https://sv1.picz.in.th/images/2023/09/29/dd0kx8R.jpeg', 'login,dashboard', 'สมาชิกใหม่ แจกเครดิตฟรี 50 บาท !!', 0),
(3, 'https://sv1.picz.in.th/images/2023/09/24/dWmvjJN.jpeg', 'dashboard,login,deposit,withdraw', 'แจ้งลูกค้า!! ไทยพาณิชย์ธนาคารปิดปรับปรุงชั่วคราว', 0),
(4, 'https://sv1.picz.in.th/images/2023/10/09/ddTiJsz.jpeg', 'dashboard,login', 'สมาชิกใหม่ แจกเครดิตฟรี 50 บาท !!', 1);
...
INSERT INTO `meta_promotion_setting` (`id`, `meta`, `status`, `deleted`, `promotion_type`) VALUES
(8, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/29/dd0kx8R.jpeg\",\"Title\":\"สมาชิกใหม่แจกเครดิตฟรี 50 บาท\",\"Type\":\"NewMember\",\"LimitPerDay\":\"1\",\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"3\",\"DepositType\":\"Equal\",\"Rec\":\"50\",\"Rec_type\":\"unit\",\"Limit\":\"50\",\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"500\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"100\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ทำยอด 500 ถอนได้ 100 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี\"}', 1, 0, ''),
(9, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/10/dWs6abR.jpeg\",\"Title\":\"โปรสุดคุ้ม 1 รับฟรี 30\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":1,\"DepositType\":\"Equal\",\"Rec\":\"30\",\"Rec_type\":\"unit\",\"Limit\":\"30\",\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"300\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"100\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 1 บาทเท่านั้น ทำยอด 300 ถอนได้ 100 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 0, 0, ''),
(10, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/14/dWnbzw1.jpeg\",\"Title\":\"โปรสุดคุ้ม 5 รับฟรี 30\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"5\",\"DepositType\":\"Equal\",\"Rec\":\"30\",\"Rec_type\":\"unit\",\"Limit\":\"30\",\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"300\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"100\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 5 บาทเท่านั้น ทำยอด 300 ถอนได้ 100 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 1, 0, ''),
(11, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/10/dWs6pp0.jpeg\",\"Title\":\"โปรมาแรง ฝาก 10 รับ 100\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"10\",\"DepositType\":\"Equal\",\"Rec\":\"100\",\"Rec_type\":\"unit\",\"Limit\":100,\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"800\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"150\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 10 บาทเท่านั้น ทำยอด 800 ถอนได้ 150 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 1, 0, ''),
(12, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/10/dWs6G4u.jpeg\",\"Title\":\"โปรสุดฮิต 15 รับฟรี 100\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"15\",\"DepositType\":\"Equal\",\"Rec\":\"100\",\"Rec_type\":\"unit\",\"Limit\":100,\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"600\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"150\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 15 บาทเท่านั้น ทำยอด 600 ถอนได้ 150 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 1, 0, ''),
(13, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/10/dWs6LnI.jpeg\",\"Title\":\"โปรสุดฮอต 19 รับฟรี 100\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"19\",\"DepositType\":\"Equal\",\"Rec\":\"100\",\"Rec_type\":\"unit\",\"Limit\":100,\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"600\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"180\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 19 บาทเท่านั้น ทำยอด 600 ถอนได้ 180 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 1, 0, ''),
(14, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/10/dWs6LnI.jpeg\",\"Title\":\"โปรสุดฮอต 25 รับฟรี 120\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"25\",\"DepositType\":\"Equal\",\"Rec\":\"120\",\"Rec_type\":\"unit\",\"Limit\":\"120\",\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"600\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"200\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 25 บาทเท่านั้น ทำยอด 600 ถอนได้ 200 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 0, 0, ''),
(15, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/10/dWs6mdP.jpeg\",\"Title\":\"โปรแตกหนัก 49 รับฟรี 100\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"49\",\"DepositType\":\"Equal\",\"Rec\":\"100\",\"Rec_type\":\"unit\",\"Limit\":\"100\",\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"400\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"200\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 49 บาทเท่านั้น ทำยอด 400 ถอนได้ 200 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 1, 0, ''),
(16, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/10/dWs6mdP.jpeg\",\"Title\":\"โปรแตกหนัก 75 รับฟรี 150\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"75\",\"DepositType\":\"Equal\",\"Rec\":\"150\",\"Rec_type\":\"unit\",\"Limit\":\"150\",\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"500\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"250\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 75 บาทเท่านั้น ทำยอด 500 ถอนได้ 250 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 0, 0, ''),
(17, '{\"Banner\":\"https://sv1.picz.in.th/images/2023/09/10/dWs6yZt.jpeg\",\"Title\":\"โปรโคตรปัง 99 รับฟรี 300\",\"Type\":\"NewDay\",\"LimitPerDay\":1,\"From\":\"00:00:00\",\"To\":\"00:00:00\",\"Deposit\":\"99\",\"DepositType\":\"Equal\",\"Rec\":\"300\",\"Rec_type\":\"unit\",\"Limit\":\"300\",\"LimitType\":\"DepositSumBonus\",\"TurnOver\":\"1200\",\"TurnType\":\"unit\",\"TurnCal\":\"credit_bonus\",\"TurnTypeWithdraw\":\"credit\",\"TypeTakeTurn\":\"SLOT\",\"MaxWithdraw\":\"400\",\"note_pro\":\"เงื่อนไขและกติกาการเล่น ฝากยอด 99 บาทเท่านั้น ทำยอด 1200 ถอนได้ 400 เล่นได้เฉพาะสล็อตเท่านั้น ห้ามค้างฟรีสปิ้นเก็นไว้ หากทำผิดกฎงดถอนทุกกรณี โปรนี้รับได้วันละ 1 ครั้งเท่านั้น\"}', 1, 0, '');
...
INSERT INTO `meta_setting` (`id`, `meta`, `value`) VALUES
(1, 'withdraw_setting', '{\"key_valid\":\"ok\",\"MinWithdraw\":\"100\",\"MinAutoWithdraw\":\"0\",\"enable_auto\":0,\"enable\":1}'),
(2, 'website_online_setting', '{\"key_valid\":\"ok\",\"enable\":1}'),
(3, 'deposit_setting', '{\"key_valid\":\"ok\",\"MinDeposit\":\"1\",\"enable\":1}'),
(4, 'deposit_ingame', '{\"key_valid\":\"ok\",\"enable\":1}'),
(5, 'getname_auto', '{\"enable\":\"1\",\"key_valid\":\"ok\"}'),
...
(13, 'card_setting', '{\"key_valid\":\"ok\",\"enable\":\"1\",\"f_card\":\"https:\\/\\/sv1.picz.in.th\\/images\\/2022\\/03\\/20\\/ryCtlk.png\",\"b_card\":\"https:\\/\\/www.i-pic.info\\/i\\/EaR3135149.png\",\"max_collect\":\"500\",\"max_user_collect\":\"1\",\"turn_name\":\"เทิร์นเกมเปิดไพ่\",\"turn\":\"1\",\"MaxWithdraw\":\"1000\",\"TurnTypeWithdraw\":\"turnover\"}'),
(14, 'wheel_setting', '{\"key_valid\":\"ok\",\"enable\":1,\"credit_collect\":\"100\",\"max_collect\":\"0\",\"max_user_collect\":\"0\",\"spinimageurl\":\"https://www.img.in.th/images/bbed45747001cfb78be79bd3d8466529.png\",\"turn_name\":\"เทิร์นกงล้อ\",\"turn\":\"0\",\"MaxWithdraw\":\"1000\",\"TurnTypeWithdraw\":\"turnover\",\"winloss\":\"0\"}'),
(15, 'wheel', '{\"key_valid\":\"ok\",\"wheel_name_1\":\"0 บาท\",\"wheel_credit_1\":\"0\",\"wheel_percent_1\":\"0\",\"wheel_name_2\":\"0 บาท\",\"wheel_credit_2\":\"0\",\"wheel_percent_2\":\"0\",\"wheel_name_3\":\"0 บาท\",\"wheel_credit_3\":\"0\",\"wheel_percent_3\":\"0\",\"wheel_name_4\":\"0 บาท\",\"wheel_credit_4\":\"0\",\"wheel_percent_4\":\"0\",\"wheel_name_5\":\"0 บาท\",\"wheel_credit_5\":\"0\",\"wheel_percent_5\":\"0\",\"wheel_name_6\":\"0 บาท\",\"wheel_credit_6\":\"0\",\"wheel_percent_6\":\"0\",\"wheel_name_7\":\"0 บาท\",\"wheel_credit_7\":\"0\",\"wheel_percent_7\":\"0\",\"wheel_name_8\":\"0 บาท\",\"wheel_credit_8\":\"0\",\"wheel_percent_8\":\"0\",\"wheel_name_9\":\"0 บาท\",\"wheel_credit_9\":\"0\",\"wheel_percent_9\":\"0\",\"wheel_credit_10\":\"0\",\"wheel_credit_11\":\"0\",\"wheel_credit_12\":\"0\",\"wheel_percent_10\":\"0\",\"wheel_percent_12\":\"99\",\"wheel_percent_11\":\"1\",\"wheel_name_10\":\"0 บาท\",\"wheel_name_11\":\"0 บาท\",\"wheel_name_12\":\"0 บาท\"}'),
(16, 'card', '{\"key_valid\":\"ok\",\"card\":[\"ไพ่ 1\",\"ไพ่ 2\",\"ไพ่ 3\",\"ไพ่ 4\",\"ไพ่ 5\",\"ไพ่ 6\"],\"card_credit\":[\"1\",\"5\",\"10\",\"20\",\"50\",\"100\"],\"card_percent\":[\"65\",\"20\",\"10\",\"4\",\"1\",\"0\"]}'),
(17, 'card_setting', '{\"key_valid\":\"ok\",\"enable\":\"1\",\"f_card\":\"https:\\/\\/sv1.picz.in.th\\/images\\/2022\\/03\\/20\\/ryCtlk.png\",\"b_card\":\"https:\\/\\/www.i-pic.info\\/i\\/EaR3135149.png\",\"max_collect\":\"500\",\"max_user_collect\":\"1\",\"turn_name\":\"เทิร์นเกมเปิดไพ่\",\"turn\":\"1\",\"MaxWithdraw\":\"1000\",\"TurnTypeWithdraw\":\"turnover\"}'),
(18, 'dailydepositreward', '{\"key_valid\":\"ok\",\"reward\":\"100\",\"countday\":\"15\",\"morecredit\":100,\"enable\":\"1\"}'),
(19, 'calculate_point', '{\"key_valid\":\"ok\",\"point\":\"0\",\"percredit\":\"100\",\"enable\":\"1\"}'),
(20, 'refund', '{\"key_valid\":\"ok\",\"Percent\":\"5\",\"Minimum\":\"100\",\"Turn\":\"1\",\"enable\":1}'),
(22, 'chat', '{\"enable\":\"0\",\"key_valid\":\"ok\",\"chatkey\":\"\"}'),
(23, 'centerweb', '{\"url\":\"https://center.ufawin999.co/\",\"key_valid\":\"ok\"}'),
(24, 'register', '{\"enable_name_dont_duplicate\":1,\"key_valid\":\"ok\"}'),
(25, 'agreement', '{\"key_valid\":\"ok\",\"agreementText\":\"<h6>การยอมรับข้อตกลงการใช้งานเว็บไซต์และการใช้งานเว็บไซต์นี้ ท่านรับทราบว่าท่านได้อ่านและเข้าใจข้อตกลงการใช้งานเว็บไซต์และท่านตกลงที่จะผูกพันและปฏิบัติตามข้อตกลงการใช้งานเว็บไซต์นี้ โปรดอย่าใช้งานเว็บไซต์นี้หากท่านไม่ตกลงที่จะผูกพันตามข้อตกลงการใช้งานนี้<\\/h6>\"}'),
(26, 'quest_daily_win', '{\"key_valid\":\"ok\",\"target\":\"10000\",\"reward_point\":\"15\",\"reward_credit\":\"0\",\"enable\":\"1\"}'),
(27, 'quest_daily_turn', '{\"key_valid\":\"ok\",\"target\":\"10000\",\"reward_point\":\"10\",\"reward_credit\":\"0\",\"enable\":\"1\"}'),
(28, 'quest_daily_dep', '{\"key_valid\":\"ok\",\"target\":\"20000\",\"reward_point\":\"5\",\"reward_credit\":\"0\",\"enable\":\"1\"}'),
(29, 'withdrawmessage', '{\"key_valid\":\"ok\",\"wit_textsimulate\":\"ชื่อ-นามสกุล : <@fullname>\\nเบอร์โทรศัพท์ : <@telno>\\nยูทเซอร์เกมส์ : <@userid>\\nธนาคาร : <@bankname>\\nเลขบัญชี : <@bankaccno>\\n-------------------------\\nยอดถอน : <@amount>\\n-------------------------\\nเวลาทำรายการ : <@date>\\nผู้ทำรายการโดย : <@approveby><@telno>\",\"wit_textfomrat\":\"ชื่อ-นามสกุล : <@fullname>\\r\\nเบอร์โทรศัพท์ : <@userid>\\r\\nยูทเซอร์เกมส์ : <@userid>\\r\\nธนาคาร : <@bankname>\\r\\nเลขบัญชี : <@bankaccno>\\r\\n-------------------------\\r\\nยอดถอน : <@amount>\\r\\n-------------------------\\r\\nเวลาทำรายการ : <@date>\\r\\nผู้ทำรายการโดย : <@approveby>\"}'),
(30, 'depositmessage', '{\"key_valid\":\"ok\",\"dep_textsimulate\":\"ชื่อ-นามสกุล : <@fullname>\\nเบอร์โทรศัพท์ : <@telno>\\nยูทเซอร์เกมส์ : <@userid>\\nธนาคาร : <@bankname>\\nเลขบัญชี : <@bankaccno>\\n-------------------------\\nยอดฝาก : <@amount>\\n-------------------------\\nเวลาทำรายการ : <@date>\\nผู้ทำรายการโดย : <@approveby><@telno>\",\"dep_textfomrat\":\"ชื่อ : <@fullname> \\r\\nเบอร์ : <@userid>\\r\\nยูทเซอร์ : <@userid>\\r\\nธนาคาร : <@bankname>\\r\\nเลขบัญชี : <@bankaccno>\\r\\n-------------------------\\r\\nยอดฝาก : <@amount>\\r\\n-------------------------\\r\\nเวลาทำรายการ : <@date>\\r\\nผู้ทำรายการ : <@approveby>\"}'),
(31, 'code_free', '{\"freeCreditRegister\":\"50\",\"freeCreditTurn\":\"500\",\"enable\":1,\"key_valid\":\"ok\",\"promotion_id\":5}'),
(32, 'line_login', '{\"CLIENT_ID\":\"2001490737\",\"CLIENT_SECRET\":\"bd939b4a1b4c1f432a8ced7fc4b509f6\",\"CALLBACK_URL\":\"http://100.88.56.226:9500/api/lineconnect/LoginLineCallback\",\"enable\":1}'),
(33, 'pgsoftlock', '{\"key_valid\":\"ok\",\"enable\":0}'),
(34, 'report_percent_setting', '{\"key_valid\":\"ok\",\"percent_all_0\": 50,\"percent_all_1\":60,\"percent_all_2\":40\r\n,\"percent_paid_1\":40}');
...
INSERT INTO `notice_admin` (`id`, `username`, `mobile_no`, `icon`, `title`, `text`, `meta_data`, `date`, `status`) VALUES
(1, 'mb000002', '', 'success', '-', 'สมัครสมาชิกเรียบร้อยแล้ว2025-07-08T10:31:06', '', '2025-07-08 03:31:07', 1),
(2, '', '', 'success', '-', 'สมัครสมาชิกเรียบร้อยแล้ว2025-07-09T15:11:07', '', '2025-07-09 08:11:08', 1),
(3, '', '', 'success', '-', 'สมัครสมาชิกเรียบร้อยแล้ว2025-07-09T15:12:34', '', '2025-07-09 08:12:34', 1),
(4, '', '', 'success', '-', 'สมัครสมาชิกเรียบร้อยแล้ว2025-07-09T15:13:02', '', '2025-07-09 08:13:02', 1),
(5, '', '', 'success', '-', 'สมัครสมาชิกเรียบร้อยแล้ว2025-07-09T15:15:10', '', '2025-07-09 08:15:10', 1),
(6, '', '', 'success', '-', 'สมัครสมาชิกเรียบร้อยแล้ว2025-07-21T11:18:05', '', '2025-07-21 04:18:05', 1),
(7, 'mb000008', '', 'success', '-', 'สมัครสมาชิกเรียบร้อยแล้ว2025-07-29T19:42:12', '', '2025-07-29 12:42:12', 1);
...
--
-- Table structure for table `offer_message`
--
...
--
-- Table structure for table `otp_ip`
--
...
INSERT INTO `page_admin` (`id`, `page_name`, `page_name_th`, `status`, `menuorder`) VALUES
(1, 'dashboard', 'แดชบอร์ด', 0, 0),
(2, 'apps-members-manage', 'จัดการสมาชิก', 1, 15),
(47, 'apps-report-deposit', 'รายงานการฝาก', 0, 5),
(48, 'apps-report-withdraw', 'รายงานการถอน', 0, 5),
(49, 'apps-report-activity', 'รายงานกิจกรรม', 0, 5),
(50, 'apps-report-aff', 'รายงานการชวนเพื่อน', 0, 5),
(51, 'apps-report-refund', 'รายงานคืนยอด', 0, 5),
(52, 'apps-report-summary', 'รายงานสรุป', 0, 5),
(53, 'apps-report-betlog', 'ประวัติการเล่น', 0, 5),
(54, 'apps-report-transferout', 'รายงานการโยกเงิน', 0, 5),
(55, 'apps-report-smslog', 'SMS Log', 0, 5),
(56, 'apps-members-depwit', 'ฝากถอน', 0, 5),
(57, 'apps-members-depdrawerror', 'รายการฝาก(ผิดพลาด)', 0, 5),
(58, 'apps-members-withdrawapprove', 'รายการถอน(รออนุมัติ)', 0, 5),
(59, 'apps-alliances-manage', 'จัดการพันธมิตร', 0, 5),
(60, 'apps-agent-refer', 'จัดการแหล่งที่มา', 0, 5),
(61, 'apps-bank-admin', 'ตั้งค่าธนาคาร', 0, 5),
(62, 'apps-bank-transaction', 'ยอดเดินบัญชีธนาคาร', 0, 5),
(63, 'apps-truewallet-admin', 'ตั้งค่าทรูวอเลท', 0, 5),
(64, 'apps-setting-general', 'ตั้งค่าทั่วไป', 0, 5),
(65, 'apps-promotion-setting', 'ตั้งค่าโปรโมชั่น', 0, 5),
(66, 'apps-line-linesettingmain', 'ตั้งค่าไลน์', 1, 90),
(67, 'apps-affilate-affilatesettingmain', 'ตั้งค่าพันธมิตร', 0, 5),
(68, 'apps-staff-manage', 'ตั้งค่าผู้ดูแล', 1, 100),
(69, 'apps-staff-permission', 'ตั้งค่ากลุ่มผู้ใช้งาน', 1, 110),
(70, 'apps-settingpopup-manage', 'ตั้งค่าป๊อปอัพ', 0, 5),
(71, 'apps-setting-daily', 'ตั้งค่าฝากต่อเนื่อง', 0, 5),
(72, 'apps-setting-announcement', 'ตั้งค่าข้อความประกาศ', 0, 5),
(73, 'apps-setting-banner', 'ตั้งค่าแบนเนอร์', 0, 5),
(74, 'apps-setting-game', 'ตั้งค่าเกม', 0, 5),
(75, 'apps-setting-uxui', 'ตั้งค่า Ux/Ui', 0, 5),
(76, 'apps-setting-admin-password', 'เปลี่ยนพาสเวิร์ด', 1, 120),
(77, 'apps-setting-admin-pin', 'ตั้งรหัสถอนเงิน', 0, 5),
(78, 'apps-agent-account', 'ตั้งค่าเอเจนท์', 0, 5),
(79, 'apps-loantype-setting', 'ประเภทการกู้', 0, 80),
(80, 'apps-loan-onduedate', 'รายการนัดชำระ-ถึงวันนัดชำระ', 0, 20),
(81, 'apps-loan-overduedate', 'รายการนัดชำระ-เกินวันนัดชำระ', 0, 30),
(82, 'apps-loan-closed', 'รายการนัดชำระ-ปิดหนี้แล้ว', 0, 40),
(83, 'apps-loan-all', 'รายการนัดชำระ-ทั้งหมด', 0, 50),
(84, 'apps-report-loanall', 'รายงานเงินกู้ทั้งหมด', 0, 60),
(85, 'apps-report-paidsuccess', 'รายงานชำระเงินสำเร็จ', 0, 70),
(86, 'dashboardsummary', 'แดชบอร์ดสรุป', 0, 10),
(87, 'apps-setting-percentreport', 'ตั้งค่า % รายงาน', 0, 95),
(88, 'apps-report-oldsummary', 'รายงานสรุปแบบเก่า', 0, 75),
(89, 'apps-setting-subscription-type', 'ตั้งค่าประเภท Subscription', 1, 95),
(90, 'apps-product-setting', 'ตั้งค่าสินค้า', 1, 96),
(91, 'apps-group-sub', 'กลุ่มการสมัครสมาชิก', 1, 96),
(92, 'order-wait-invite', 'รายการรอการเชิญเข้ากลุ่ม', 1, 96),
(93, 'order-wait-approve', 'รายการรอการอนุมัติ', 1, 96),
(94, 'order-wait-payment', 'รายการรอชำระเงิน', 1, 96),
(95, 'order-nearexpire', 'รายการใกล้หมดอายุ', 1, 96),
(96, 'order-expired', 'รายการหมดอายุ', 1, 96);
...
CREATE TABLE `product_list` (
  ...
  `use_credit` decimal(10,2) NOT NULL,
  `status` int NOT NULL DEFAULT '1',
  `type` varchar(100) NOT NULL DEFAULT '',
  `product_desc` text NOT NULL,
  `give_credit` decimal(10,2) NOT NULL DEFAULT '0.00',
  `subscription_day` int NOT NULL DEFAULT '1',
  `subscription_times` int DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `subdistricts` (`id`, `zip_code`, `name_th`, `name_en`, `district_id`) VALUES
...
--
-- Dumping data for table `subscription_group`
--
...
--
-- Table structure for table `subscription_group_payment`
--

CREATE TABLE `subscription_group_payment` (
  `id` bigint NOT NULL,
...
--
-- Table structure for table `subscription_group_user`
--
...
ALTER TABLE `admin_bank`
  ...
  ADD KEY `bank_acc_number` (`bank_acc_number`),
...
--
-- Indexes for table `am_group_page_permission`
--
ALTER TABLE `am_group_page_permission`
  ADD PRIMARY KEY (`id`),
  ADD KEY `am_group_id` (`am_group_id`),
...
--
-- Indexes for table `bank_running`
--
...
--
-- Indexes for table `email_accept_member`
--
ALTER TABLE `email_accept_member`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `line_chat_active`
--
ALTER TABLE `line_chat_active`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bot_user_id` (`bot_user_id`),
  ADD KEY `chat_with_user_id` (`chat_with_user_id`),
  ADD KEY `chat_datetime` (`chat_datetime`),
  ADD KEY `active` (`active`),
  ADD KEY `last_chattime` (`last_chattime`),
  ADD KEY `reply_by` (`reply_by`),
  ADD KEY `close_by` (`close_by`),
  ADD KEY `reply_datetime` (`reply_datetime`);

--
-- Indexes for table `line_chat_message`
--
ALTER TABLE `line_chat_message`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bot_user_id` (`bot_user_id`),
  ADD KEY `chat_with_user_id` (`chat_with_user_id`),
  ADD KEY `chat_with_user_id_2` (`chat_with_user_id`),
  ADD KEY `message_type` (`message_type`),
  ADD KEY `reply_to_id` (`reply_to_id`),
  ADD KEY `send_by` (`send_by`),
  ADD KEY `is_deleted` (`is_deleted`),
  ADD KEY `is_read` (`is_read`),
  ADD KEY `is_sending` (`is_sending`),
  ADD KEY `send_completed` (`send_completed`),
  ADD KEY `message_datetime` (`message_datetime`),
  ADD KEY `line_chat_active_id` (`line_chat_active_id`);

--
-- Indexes for table `line_contact`
--
ALTER TABLE `line_contact`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bot_user_id` (`bot_user_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `alias_userid` (`alias_userid`);

--
-- Indexes for table `line_quick_message`
--
ALTER TABLE `line_quick_message`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `line_sent_message`
--
ALTER TABLE `line_sent_message`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `line_setting`
--
...
ALTER TABLE `membership_order_history`
  ...
  ADD KEY `start_at` (`start_date`),
  ADD KEY `end_at` (`end_date`),
  ADD KEY `buy_at` (`buy_date`),
  ADD KEY `approve_by` (`approve_by`),
  ADD KEY `approve_at` (`approve_date`),
...
--
-- Indexes for table `offer_message`
--
ALTER TABLE `offer_message`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `otp_ip`
--
ALTER TABLE `otp_ip`
  ADD PRIMARY KEY (`id`),
  ADD KEY `date` (`date`);
...
ALTER TABLE `page_admin`
  ...
  ADD KEY `page_name_th` (`page_name_th`),
  ADD KEY `status` (`status`),
...
--
-- Indexes for table `subscription_group`
--
...
--
-- Indexes for table `subscription_group_payment`
--
...
--
-- Indexes for table `subscription_group_user`
--
ALTER TABLE `subscription_group_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `is_header_group` (`is_header_group`);
...
--
-- AUTO_INCREMENT for table `am_group_page_permission`
--
ALTER TABLE `am_group_page_permission`
...
--
-- AUTO_INCREMENT for table `email_accept_member`
--
ALTER TABLE `email_accept_member`
...
--
-- AUTO_INCREMENT for table `latest_line_update`
--
ALTER TABLE `latest_line_update`
...
--
-- AUTO_INCREMENT for table `line_quick_message`
--
ALTER TABLE `line_quick_message`
...
--
ALTER TABLE `notice_user`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52520;
...
CREATE TABLE `payment_history` (
  ...
  `payment_method_types` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
