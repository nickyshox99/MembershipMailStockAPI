...
const SubscriptionTypeList = require('../models/subscriptiontype.model');
...
exports.getSubscriptionType = async function(req, res) {
        ...
        else
        {
            ...
            if (headers.userid.length === 0 || headers.token.length === 0) {
                ...
                if (IsAuth) 
                {
                    ...
                    let tmpData = await SubscriptionTypeList.findAll(req.body.searchword);
...
exports.getActiveSubscriptionType = async function(req, res) {

    try {
        console.log('getActiveSubscriptionType');
        ...
        else
        {
            ...
            if (headers.userid.length === 0 || headers.token.length === 0) {
                ...
                if (IsAuth) 
                {
                    ...
                    let tmpData = await SubscriptionTypeList.findAllActive(req.body.searchword);
...
exports.getSubscriptionTypeById = async function(req, res) {

    try {
        console.log('getSubscriptionTypeById');
        ...
        else
        {
            ...
            if (headers.userid.length === 0 || headers.token.length === 0) {
                ...
                if (IsAuth)             
                {
                    let tmpData = await SubscriptionTypeList.findById(req.params.Id);                
        ...
        else
        {
            ...
            if (headers.userid.length === 0 || headers.token.length === 0) {
                ...
                if (IsAuth) 
                {
                    ...
                    let tmpData = await SubscriptionTypeList.create(req.body);
        ...
        else
        {
            ...
            if (headers.userid.length === 0 || headers.token.length === 0) {
                ...
                if (IsAuth) 
                {
                    ...
                    let tmpData = await SubscriptionTypeList.updateByID(req.body);
        ...
        else
        {
            ...
            if (headers.userid.length === 0 || headers.token.length === 0) {
                ...
                if (IsAuth) 
                {
                    ...
                    let tmpData = await SubscriptionTypeList.deleteByID(req.body);
